    ...
    var Mapplic = function () {
        ...
        function Tooltip() {
            ...
            this.init = function () {
                ...
                this.link = $('<a target="_blank">Ver ubicación</a>').addClass('mapplic-tooltip-link').attr('href', '#').hide().appendTo(this.el);
            ...
            this.position = function () {
                if (this.location) {
                    ...
                    if (self.o.smartip) {
                        ...
                        // Left-right check
                        if (this.el.outerWidth() / 2 > cx) verticalPos = 0.5 - (this.el.outerWidth() / 2 - cx) / this.el.outerWidth();
                        else if ((self.container.width() - cx - this.el.outerWidth() / 2) < 0) verticalPos = 0.5 + (cx + this.el.outerWidth() / 2 - self.container.width()) / this.el.outerWidth();
        ...
        function Sidebar() {
            ...
            this.init = function () {
                ...
                if (self.o.search) {
                    var titulo = $('<div>Bucaramanga</div>').addClass('mapplic-titulo').appendTo(this.el);
                ...
                this.notfound = $('<p></p>').addClass('mapplic-not-found').text('No se encontraron resultados. Por favor revise nuevamente.').appendTo(listContainer);
        ...
        function DevTools() {
            ...
            this.init = function () {
                ...
                $('.mapplic-layer', self.map).on('mousemove', function (e) {
                    ...
                    window.global_x = parseFloat(x).toFixed(4)
                    window.global_y = parseFloat(y).toFixed(4)
                });
            }
        }
        // Clear Button
